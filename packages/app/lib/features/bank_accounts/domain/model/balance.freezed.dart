...
/// @nodoc
@JsonSerializable()
class _$BalanceImpl with DiagnosticableTreeMixin implements _Balance {
  const _$BalanceImpl(
      {required this.id,
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'Balance(id: $id, userId: $userId, createdAt: $createdAt, updatedAt: $updatedAt, amount: $amount)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, userId, createdAt, updatedAt, amount);
...
abstract class _Balance implements Balance {
  const factory _Balance(
      ...
      required final double amount}) = _$BalanceImpl;
